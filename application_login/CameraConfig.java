...
public class CameraConfig extends AppCompatActivity implements TaskCallBack{
    ...
    private CameraDevice.StateCallback deviceStateCallback = new CameraDevice.StateCallback() {
        ...
        public void onError(CameraDevice camera, int error) {
            Toast.makeText(CameraConfig.this, "카메라를 열지 못했습니다.", Toast.LENGTH_SHORT).show();
        }
    };
    ...
    private CameraCaptureSession.StateCallback mSessionPreviewStateCallback = new CameraCaptureSession.StateCallback() {
        ...
        public void onConfigureFailed(@NonNull CameraCaptureSession session) {
            Toast.makeText(CameraConfig.this, "카메라 구성 실패", Toast.LENGTH_SHORT).show();
        }
    };
    ...
    @Override
    public void closeActivity(Bitmap bitmap) {

       /* Intent intent = new Intent();
        intent.putExtra("data", pubbitmap );
        setResult(RESULT_OK,intent);
        finish();*/

        Intent intent = new Intent();
        intent.putExtra("data", bitmap);
        CameraConfig.this.setResult( RESULT_OK ,intent);
        CameraConfig.this.finish();
    }


    private class SaveImageTask extends AsyncTask<Bitmap, Void, Void> {
        //사진 저장 후 액션을 여기서 코딩!!(3조)
        Bitmap bitmap = null;
        ...
        protected void onPostExecute(Void aVoid) {
           ...
           // imageView.setImageBitmap();
            ...
            Toast.makeText(CameraConfig.this, "사진을 저장하였습니다.", Toast.LENGTH_SHORT).show();
           // myTask.closeActivity(bitmap);
            ...
            new Handler().postDelayed(new Runnable()
            {
                ...
                public void run()
                {
                    ...
                    thisAct.setResult(RESULT_OK ,intent);
                    thisAct.finish();
                }
            }, 1000);
