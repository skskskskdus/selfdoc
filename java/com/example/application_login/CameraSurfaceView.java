...
public class CameraSurfaceView extends Thread{
    ...
    public CameraSurfaceView(Context context, TextureView textureView) {
        mContext = context;
    ...
    public void openCamera() {
        ...
        try {
            ...
            if(permissionCamera == PackageManager.PERMISSION_DENIED) {
              //  ActivityCompat.requestPermissions((Activity) mContext, new String[]{Manifest.permission.CAMERA}, Activity_Keepfile.REQUEST_CAMERA);
            } else {
